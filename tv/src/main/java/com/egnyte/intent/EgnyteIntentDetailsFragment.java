...
public class EgnyteIntentDetailsFragment extends DetailsFragment {
    private static final String TAG = "EgnyteIntentDetailsFrag";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mDorPresenter.setSharedElementEnterTransition(getActivity(),
                EgnyteIntentDetailsActivity.SHARED_ELEMENT_NAME);
    ...
    private final class ItemViewClickedListener implements OnItemViewClickedListener {
        ...
        public void onItemClicked(Presenter.ViewHolder itemViewHolder, Object item,
            ...
            if (item instanceof Movie) {
                ...
                Intent intent = new Intent(getActivity(), EgnyteIntentDetailsActivity.class);
                intent.putExtra(EgnyteIntentDetailsActivity.MOVIE, movie);

                Bundle bundle = ActivityOptionsCompat.makeSceneTransitionAnimation(
                        getActivity(),
                        ((ImageCardView) itemViewHolder.view).getMainImageView(),
                        EgnyteIntentDetailsActivity.SHARED_ELEMENT_NAME).toBundle();
